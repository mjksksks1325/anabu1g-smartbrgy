...
<head>
    <meta charset="UTF-8">
    <title>Certificate of Indigency - {{ $certificate->certificate_number }}</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .republic { font-size: 14px; }
        .city { font-size: 16px; font-weight: bold; }
        .barangay { font-size: 24px; font-weight: bold; }
        .office { font-size: 15px; font-weight: bold; margin-top: 4px; }
        ...
        .qr-section img { width: 125px; height: 125px; }
...
<button class="print-btn" onclick="window.print()">
    🖨️ Print Certificate of Indigency
</button>

<div class="page">

    <div class="header">
        <img src="{{ asset('images/anabu-logo.jpg') }}" class="logo">
    ...
    <div class="content">
        ...
        <p>
            ...
            is a bona fide resident of Barangay Anabu I-G,
            City of Imus, Province of Cavite.
        </p>

        <p>
            This further certifies that the above-named resident
            is requesting this Certificate of Indigency for
            <strong>
                {{ $certificate->purpose ?: 'assistance and other lawful purposes' }}
            </strong>.
        </p>
