...
<head>
    ...
    <title>Business Clearance - {{ $certificate->certificate_number }}</title>
...
<div class="page">
    ...
    <div class="content">
        ...
        <p>
            ...
            has been issued this Barangay Business Clearance by
            Barangay Anabu I-G, City of Imus, Province of Cavite.
        </p>

        <p>
            This clearance is issued upon request for
            <strong>
                {{ $certificate->purpose ?: 'business permit and other lawful purposes' }}
            </strong>.
        </p>
