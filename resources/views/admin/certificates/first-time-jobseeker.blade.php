...
<head>
    ...
    <title>First Time Jobseeker Certificate - {{ $certificate->certificate_number }}</title>
...
<button class="print-btn" onclick="window.print()">
    🖨️ Print First Time Jobseeker Certificate
</button>
...
<div class="page">
    ...
    <div class="content">
        ...
        <p>
            ...
            resident's application as a first-time jobseeker and for
            <strong>
                {{ $certificate->purpose ?: 'employment requirements' }}
            </strong>.
        </p>
